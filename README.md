...
## 🛠️ Tech Stack
C++ • Python • JavaScript • React • Next.js • FastAPI • SQL • AWS • Git • Linux

## 🏆 Highlights
- 🎓 NTSE Scholar
- 🏅 TechExpo National Finalist — IIT Guwahati
- 🛰️ ISRO Remote Sensing & GIS Certification
- ⚡ IEEE Monash Student Branch — Ancillary Officer
- 📝 Creative writing — 150 members, 100,000+ hits on Patreon

## 💼 Experience
- **Data Storage Subsystem Engineer** @ Monash High Altitude Balloon
- **Ancillary Officer** @ IEEE Monash Student Branch
- **Peer Mentor** @ Monash University
